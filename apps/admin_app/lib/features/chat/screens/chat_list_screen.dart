                ...
                if (conversation.type == 'direct') {
                  ...
                  if (currentUserId != null && conversation.participants != null) {
                    ...
                    if (otherParticipants.isNotEmpty) {
                      ...
                      // Convert pref: URLs to API URLs
                      if (participantPhotoUrl != null && participantPhotoUrl!.startsWith('pref:profile_photo_')) {
                        participantPhotoUrl = '${ApiConfig.baseUrl.replaceAll('/api', '')}/api/users/${otherParticipant.userId}/photo';
                      }
