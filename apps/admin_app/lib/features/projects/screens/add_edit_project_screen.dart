...
class _AddEditProjectScreenState extends State<AddEditProjectScreen> {
  ...
  void initState() {
    ...
    // Note: We're not using coordinates anymore, only address text
    // The map picker is just for selecting/confirming the address text
  }
  ...
  Future<void> _saveProject() async {
    ...
    final project = widget.project?.copyWith(
          ...
          latitude: null, // Don't save coordinates, only address text
          longitude: null, // Don't save coordinates, only address text
                      ...
                      MaterialPageRoute(
                        builder: (context) => ProjectLocationPicker(
                          ...
                          onLocationSelected: (location) {
                            // Update address text only, don't save coordinates
                            setState(() {
