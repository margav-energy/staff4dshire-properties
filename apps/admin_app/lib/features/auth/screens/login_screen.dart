  ...
  Future<void> _handleLogin() async {
    ...
    if (success && mounted) {
      ...
      if (user != null) {
        ...
        // Show welcome dialog and navigate after a brief delay
        WelcomeDialog.show(context, user);
        
        // Navigate after dialog appears
        if (mounted) {
                  ...
                  TextButton(
                    ...
                    child: Wrap(
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Text(
                            'New here? Learn about the invitation process',
                            style: TextStyle(
                              color: theme.colorScheme.primary,
                            ),
                            textAlign: TextAlign.center,
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                // Call password reset API first (while dialog is still open)
                await PasswordResetApiService.requestPasswordReset(email: email);
                ...
                if (context.mounted) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'If an account exists with $email, a password reset link has been sent. Please check your inbox.',
                      ),
