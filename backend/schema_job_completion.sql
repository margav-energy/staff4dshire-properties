...
-- Note: May require superuser privileges. If you get an error, run as superuser:
-- psql -U postgres -d staff4dshire -f backend/schema_job_completion.sql
DO $$
BEGIN
...
CREATE OR REPLACE VIEW invoice_jobs AS
SELECT 
    i.id as invoice_id,
    i.invoice_number,
    i.project_id,
