...
import '../../../core/services/company_invitation_api_service.dart';
import '../../../core/models/company_invitation_model.dart';
    ...
    try {
      ...
      if (success && mounted) {
        ...
        if (user != null) {
          ...
          if (mounted) {
            // Redirect to onboarding for new staff members
            // Note: Default to employee onboarding - can be changed to CIS form based on user type
            // To route to CIS form, use: context.go('/onboarding/cis')
            Future.delayed(const Duration(seconds: 2), () {
              if (mounted) {
                // Check if user should use CIS form (can be determined by email pattern, 
                // role selection, or user preference)
                // For now, default to employee onboarding
